    ...
    return (
      <div className="terminal-stack">
        ...
        <TerminalLine variant="list">
          - DC fan: comics, vintage finds, hard-to-track single issues, action figures, and anything DC really
        </TerminalLine>
        <TerminalLine variant="list">
          - big fraghead: I collect perfumes, especially the niche and weirdly memorable kind
        </TerminalLine>
        <TerminalLine variant="list">
          - open-source LLM enthusiast: good models, local experimentation, and not paying for credits when I do not have to
        </TerminalLine>
        <TerminalLine variant="list">
        ...
        <TerminalGap />
        <TerminalLine variant="body">
          So yes, I build AI systems and backend workflows. But I also care about taste, storytelling, and energy.
        </TerminalLine>
        <TerminalLine variant="body">
    ...
    return (
      <div className="terminal-stack">
        ...
        {profile.focus.map((item) => (
          <TerminalLine key={item} variant="list">{item}</TerminalLine>
        ))}
      </div>
    );
  }
